...
const mockTasks: MaintenanceTask[] = [
    {
        ...
        description: 'Routine inspection of all solar panels for damage and cleanliness.',
        priority: 'high',
        status: 'pending',
        ...
        assignedTo: 'John Doe',
        notes: 'Check for cracks and dirt accumulation.',
        tags: ['routine', 'monthly']
    },
    {
        id: '2',
        title: 'Clean Solar Panels',
        description: 'Thorough cleaning of solar panels to ensure maximum efficiency.',
        priority: 'medium',
        status: 'in_progress',
        dueDate: new Date().toISOString(),
        createdAt: new Date().toISOString(),
        ...
        notes: 'Use non-abrasive cleaning solutions.',
        tags: ['routine', 'monthly']
    },
    {
        id: '3',
        title: 'Repair Inverter',
        description: 'Fix the malfunctioning inverter in section B.',
        priority: 'high',
        status: 'overdue',
        ...
        notes: 'Order replacement parts if necessary.',
        tags: ['urgent']
    },
    {
        id: '4',
        title: 'Upgrade Monitoring Software',
        description: 'Update the solar monitoring software to the latest version.',
        priority: 'low',
        status: 'completed',
        ...
        notes: 'Backup current settings before upgrade.',
        tags: ['software', 'quarterly']
    },
    {
        id: '5',
        title: 'Inspect Solar Panels',
